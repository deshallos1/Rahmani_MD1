...
const fetchGitHubRepoDetails = async () => {
  try {
    const _0x1c6838 = await axios.get("https://api.github.com/repos/deshallos1/Rahmani_MD1");
    const {
      name: _0x4ae93b,
      ...
      await _0x23108e.sendMessage(_0x3247d3, {
        ...
        'contextInfo': {
          'externalAdReply': {
            ...
            'mediaUrl': "https://whatsapp.com/channel/0029VavShWD1iUxb6kjV6K2T",
